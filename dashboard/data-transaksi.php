...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item mt-2">
            <a class="nav-link  active" href="file-content">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>office</title>
                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <li class="nav-item mt-2">
            <a class="nav-link  active" href="ajax-data">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>office</title>
                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <?php
        ...
        $target_dir = "../files/upload/data-transaksi-". $_SESSION['username'];
        ...
        if(isset($_POST['send'])){
          ...
          if(strpos($contents, 'insert into transaksi set nis=') !== false){
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        ...
                        <div class="container-fluid">
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="mb-2 row">
                                    <label for="staticEmail" class="col-sm-2 col-form-label">File Data Transaksi</label>
                        ...
                        <div class="container-fluid">
                          <div class="mb-2 row">
                              <label for="staticEmail" class="col-sm-2 col-form-label ms-3 p-0">Result Data Transaksi</label>
                              <div class="col-sm-5 p-0">
                              <?php
                                  $get = $conn->query("select * from ukk where user_id='$_SESSION[user_id]'");
                                  while($res = $get->fetch_array()){
                                    $con = "../files/upload/data-transaksi-". $_SESSION['username']."/".$res['file'];
                                  }
