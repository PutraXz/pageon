  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <?php
        ...
        if(isset($_POST['send'])){
          ...
          $image_akad = $_FILES['image_akad']['name'];
          $name_groom = $_POST['name_groom'];
          $father_groom = $_POST['father_groom'];
          $mother_groom = $_POST['mother_groom'];
          $child_groom = $_POST['child_groom'];
          $photo_groom = $_FILES['photo_groom']['name'];
          $name_bride = $_POST['name_bride'];
          $father_bride = $_POST['father_bride'];
          $mother_bride = $_POST['mother_bride'];
          $child_bride = $_POST['child_bride'];
          $photo_bride = $_FILES['photo_bride']['name'];
          $slug = str_replace(" ", "-", $url);
          $query = $conn->query("insert into weddings set name_url='$slug',user_id='$user_id', name_groom='$name_groom', father_groom='$father_groom', mother_groom='$mother_groom', child_groom='$child_groom', photo_groom='$photo_groom', name_bride='$name_bride', father_bride='$father_bride', mother_bride='$mother_bride', child_bride='$child_bride', photo_bride='$photo_bride', image='$image_akad', date_count='$date_count', theme_id='$theme_id'");
          if($query){
          ...
          $files = [];
            foreach ($_FILES['filename']['name'] as $a => $file){
                $files[] = [
                    $file,
                ];
                $t = json_encode($files);
            ...
            foreach($data as $item){
              ...
              $ext = explode(".", $filee);
              $ext_image = end($ext);
              if($ext_image == "png" || $ext_image == "jpg" || $ext_image == "jpeg"){
                $new = time().uniqid(true).".".$ext_image;
                 $q = $conn->query("insert into gallery set filename='$new', name_url='$slug'");
              }else{
                echo 'extensi gambar harus png,jpg,jpeg';
              };
            };
                        ...
                        <div class="container-fluid">
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="mb-2 row">
                                    ...
                                    <div class="col-sm-3 p-0">
                                        <select name="theme_id" id="" class="form-select">
                                ...
                                <div class="mb-2 row">
                                    ...
                                    <div class="col-sm-3 p-0">
                                        <input type="file" class="form-control" required name="image_akad">
                                    </div>
                                </div>
                                <div class="row ">
                                    <div class="col-md-6">
                        ...
                        <div class="container-fluid">
                          <div class="mb-2 row">
                              ...
                              <div class="col-sm-5 p-0">
                                ...
                                ?>
                                <a href="" class=""><?= 'slug/wedding-show/wedding'.$get['name_url'] ?></a>
                              </div>
                          </div>
                        </div>
                        <?php } ?>
