  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-left">
      ...
      if(isset($_POST['edit'])){
        ...
        $query = $conn->query("update kelas set nama_kelas='$nama_kelas', kompetensi_keahlian='$kompetensi_keahlian' where id_kelas='$id_kelas'");
          echo"
          <script>
              ...
              <div id="edit-<?= $data['id_kelas'] ?>" class="modal">
                <form class="modal-content animate" method="post">
                  <div class="imgcontainer">
                    <span onclick="document.getElementById('edit-<?= $data['id_kelas'] ?>').style.display='none'" class="close" title="Close Modal">&times;</span>
                  </div>

                  <div class="container-fluid">
                    <input type="hidden" name="id_kelas" value="<?= $data['id_kelas'] ?>">
                    <label for="nama_kelas"><b>Nama Kelas</b></label>
                    <input type="text" placeholder="Enter Nama Kelas" name="nama_kelas" required value="<?= $data['nama_kelas'] ?>">

                    <label for="kompetensi_keahlian"><b>Kompetensi Keahlian</b></label>
                    <input type="text" placeholder="Enter Kompetensi Keahlian" name="kompetensi_keahlian" required value="<?= $data['kompetensi_keahlian'] ?>">
      ...
      if(isset($_POST['tambah'])){
        $nama_kelas = $_POST['nama_kelas'];
        $kompetensi_keahlian = $_POST['kompetensi_keahlian'];
        $query = $conn->query("insert into kelas set nama_kelas='$nama_kelas', kompetensi_keahlian='$kompetensi_keahlian'");
          echo"
          <script>
      ...
      <div id="tambah" class="modal">
        <form class="modal-content animate" method="post">
          ...
          <div class="container-fluid">
            <input type="hidden" name="id_kelas" value="<?= $data['id_kelas'] ?>">
            <label for="uname"><b>Nama Kelas</b></label>
