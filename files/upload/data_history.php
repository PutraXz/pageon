...
<p>
<form method="post">
<input type="text" name="keyword" placeholder="Cari NISN...">
...
<select name="tahun" required="" id="tahun">
...
$query2 = $conn->query("select * from siswa INNER JOIN kelas ON kelas.id_kelas=siswa.id_kelas where siswa.nisn='$keyword'");
}else{
...
?>
<tr>
<td><a href="#" onclick="document.getElementById('details-<?php echo $data2['nisn'];?>').style.display='block'"><?php echo $no;?></a></td>
<td><a href="#" onclick="document.getElementById('details-<?php echo $data2['nisn'];?>').style.display='block'"><?php echo $data2['nisn'];?></a></td>
<td><a href="#" onclick="document.getElementById('details-<?php echo $data2['nisn'];?>').style.display='block'"><?php echo $data2['nama'];?></a></td>
<td>
<a href="#" onclick="document.getElementById('details-<?php echo $data2['nisn'];?>').style.display='block'"><?php echo $data2['nama_kelas'];?></a>
...
?>
<tr>
<td><a href="#" onclick="document.getElementById('pembayarans-<?php echo $data['nisn'];?>').style.display='block'"><?php echo $no;?></td></a>
<td><a href="#" onclick="document.getElementById('pembayarans-<?php echo $data['nisn'];?>').style.display='block'"><?php echo $data['nisn'];?></td></a>
<td><a href="#" onclick="document.getElementById('pembayarans-<?php echo $data['nisn'];?>').style.display='block'"><?php echo $data['nama'];?></td></a>
<td><a href="#" onclick="document.getElementById('pembayarans-<?php echo $data['nisn'];?>').style.display='block'"><?php echo $data['nama_kelas'];?></td></a>
<td><a href="#" onclick="document.getElementById('pembayarans-<?php echo $data['nisn'];?>').style.display='block'"><?php echo $data['nominal'];?></td></a>
<td><a href="#" onclick="document.getElementById('pembayarans-<?php echo $data['nisn'];?>').style.display='block'"><?php echo $data['bulan_dibayar'];?></td></a>
<td><a href="#" onclick="document.getElementById('pembayarans-<?php echo $data['nisn'];?>').style.display='block'"><?php echo $data['tahun_dibayar'];?></td></a>
<td><?php echo $data['nama_petugas'];?></td>      
<td>

<div id="pembayarans-<?php echo $data['nisn'];?>" class="modal">
<div class="modal-content animate">          
<div class="imgcontainer">
<span onclick="document.getElementById('pembayarans-<?php echo $data['nisn'];?>').style.display='none'" class="close" title="Close Modal">&times;</span>
</div>
<div class="container-fluid">
...
<button type="button" onclick="document.getElementById('pembayarans-<?php echo $data['nisn'];?>').style.display='none'" class="cancelbtn">Cancel</button>
</div>
</div>
</div>
<a onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data ini?')" href="data_history.php?page=hapus&id=<?php echo $data['ni'];?>">Hapus</a>
</td>
</tr>
<?php 
$no=$no+1;
...
echo "<tr><td style='text-align:center;' colspan='4'>Silahkan Cari Data Yang Kamu Inginkan</td</tr>";
}
?>
</table>
</p>
